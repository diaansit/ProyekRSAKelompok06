            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <table class="table table-primary">
                        ...
                        <tbody>
                            <?php foreach ($Anggota as $id) : ?>
                                <tr>
                                    <th scope="row"><?= $id['user_id']; ?></th>
                                    <td><?= $id['username']; ?></td>
                                    <td><?= $id['email']; ?></td>
                                    <td><?= $id['phone']; ?></td>
                                    <td>
                                        <?php echo anchor('adminprofile/edit/' . $id['user_id'], '<btn class="dropdown-item">
                                       <i class="fas fa-user-cog"></i>
                                        Setting
                                    </btn>') ?> <a href="<?= base_url(); ?>adminprofile/hapus/<?= $id['username']; ?>" class="badge badge-danger float-right" onclick="return confirm('Yakin nih?');">Hapus</a>
